...
\keywords{心理健康评估\quad   症状自评量表\quad 职业成熟度量表\quad 大五人格量表\quad 多元分析\quad 人才选拔}
\end{abstract}
...
\begin{figure}
    ...
    \begin{minipage}[c]{0.3\textwidth}
        \centering
        \includegraphics[width=0.95\textwidth]{大五雷达.png}
        \subcaption{大五样本中心均值雷达图}
        \label{fig:大五雷达}
    \end{minipage}
    \begin{minipage}[c]{0.3\textwidth}
        \centering
        \includegraphics[width=0.95\textwidth]{职业雷达.png}
        \subcaption{职业样本中心均值雷达图}
        \label{fig:职业雷达}
    \end{minipage}
    \begin{minipage}[c]{0.3\textwidth}
        \centering
        \includegraphics[width=0.95\textwidth]{病症雷达.png}
        \subcaption{病症样本中心均值雷达图}
        \label{fig:病症雷达}
    \end{minipage}
    \caption{聚类样本中心均值雷达图}
    \label{fig:rader}
...
\begin{figure}
    ...
    \begin{minipage}[c]{0.48\textwidth}
        \centering
        \includegraphics[height=0.2\textheight]{dendrogram.png}
        \subcaption{聚类树状图}
    \end{minipage}
    \begin{minipage}[c]{0.48\textwidth}
        \centering
        \includegraphics[height=0.2\textheight]{病症变量聚类.png}
        \subcaption{聚类树状图}
    \end{minipage}
    \caption{聚类树状图}
...
\begin{figure}[!h]
    \centering
    \includegraphics[width=.6\textwidth]{score分布.png}
    \caption{堆叠面积图}
    \label{fig:cluster}
\end{figure}
